...
##data can be downloaded from below url
## url: https://www.kaggle.com/c/siim-acr-pneumothorax-segmentation
# original problem was to detect where is the pneumothorax in image
# but here wie will try to make it a classification problem and try to solve it
