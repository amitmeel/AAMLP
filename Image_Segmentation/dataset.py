#The training dataset is a CSV file consisting only of image ids which are also filenames.

# dataset class which outputs image and mask images.
...
class SIIMDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        # we iterate over the image ids to  store image and maskpaths
